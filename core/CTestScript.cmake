...
# installation of SALSA on the host followed by tests for all plugins. The
...
# 	ctest -S /mnt/sharedRepos/salsa/salsa/CTestScript.cmake,Linux

# The build name is the same on all sites
SET( CTEST_BUILD_NAME "SALSA" )
...
IF( CTEST_SCRIPT_ARG STREQUAL "Linux" )
	...
	SET( CTEST_SOURCE_DIRECTORY "/mnt/sharedRepos/salsa/salsa" )
	SET( CTEST_BINARY_DIRECTORY "/home/nursery/build-salsa" )
	SET( SALSA_INSTALLATION_DIRECTORY "/usr/local" )

	# Setting the generator to use
	SET( CTEST_CMAKE_GENERATOR "Unix Makefiles" )
	# Setting the build options
	SET( CTEST_BUILD_OPTIONS "\"-DCMAKE_CXX_FLAGS=-Wall -Wextra\" \"-DCMAKE_C_FLAGS=-Wall -Wextra\" -DDISPLAY_DEVELOPER_WARNINGS=OFF -DEXPERIMENTAL_NEWTON_FROMSOURCE=ON -DSALSA_USE_QT5=OFF -DUSE_GRAPHVIZ=OFF -DUSE_GSL=ON \"-DCMAKE_INSTALL_PREFIX=${SALSA_INSTALLATION_DIRECTORY}\"" )
ELSEIF( CTEST_SCRIPT_ARG STREQUAL "Windows" )
	# Setting source and binary dir
	SET( CTEST_SOURCE_DIRECTORY "E:\\salsa\\salsa" )
	SET( CTEST_BINARY_DIRECTORY "C:\\salsa\\build-salsa" )
	SET( SALSA_INSTALLATION_DIRECTORY "C:/salsa/install-salsa" )

	# Setting the generator to use
	SET( CTEST_CMAKE_GENERATOR "Visual Studio 10" )
	# Setting the build options
	SET( CTEST_BUILD_OPTIONS "-DDISPLAY_DEVELOPER_WARNINGS=OFF -DEXPERIMENTAL_NEWTON_FROMSOURCE=ON -DSALSA_USE_QT5=OFF -DUSE_GRAPHVIZ=OFF -DUSE_GSL=ON \"-DCMAKE_INSTALL_PREFIX=${SALSA_INSTALLATION_DIRECTORY}\"" )
...
FILE( REMOVE_RECURSE "${SALSA_INSTALLATION_DIRECTORY}" )
...
# Now that we have finished SALSA tests, we can test plugins. First of all
...
FILE( GLOB_RECURSE PLUGINS_TEST_SCRIPTS "${CTEST_SCRIPT_DIRECTORY}/../salsaPlugins/CTestScript.cmake" )
LIST( REMOVE_ITEM PLUGINS_TEST_SCRIPTS "${CTEST_SCRIPT_DIRECTORY}/../salsaPlugins/iCub/CTestScript.cmake" )
LIST( REMOVE_ITEM PLUGINS_TEST_SCRIPTS "${CTEST_SCRIPT_DIRECTORY}/../salsaPlugins/OpenCL/CTestScript.cmake" )
...
LIST( INSERT PLUGINS_TEST_SCRIPTS 0 "${CTEST_SCRIPT_DIRECTORY}/../salsaPlugins/iCub/CTestScript.cmake" )
LIST( INSERT PLUGINS_TEST_SCRIPTS 0 "${CTEST_SCRIPT_DIRECTORY}/../salsaPlugins/OpenCL/CTestScript.cmake" )
