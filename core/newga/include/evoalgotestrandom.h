...
#ifndef EVOALGOTESTRANDOM_H
#define EVOALGOTESTRANDOM_H
 ...
 */
class SALSA_NEWGA_API EvoAlgoTestRandom : public EvoAlgoTest
{
...
public:
	...
	{
		Logger::error("NOT IMPLEMENTED (EvoAlgoTestRandom::save)");
		abort();
	}
