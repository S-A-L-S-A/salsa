 ...
 * \ingroup ga_gas
 */
class FARSA_GA_API ParallelGA : public GeneticAlgo {
public:
	/*! Constructor */
	ParallelGA();
	/*! Destructor */
...
private:
	...
	public:
		//--- Constructor
		evaluationThread( Evaluation* eProto );
		//--- Destructor
		~evaluationThread();
	...
	static void runStepWrapper( ParallelGA::evaluationThread* e );
	/*! QFuture used to know when all thread has completed their work */
	QFuture<void>* future;
};
